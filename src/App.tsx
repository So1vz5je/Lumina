...
const buildLinuxMenuItems = (mode: AnalysisMode): MenuItem[] => {
  ...
  menuGroups.push(
    ...
    {
      key: 'linux_process_group',
      icon: <AppstoreOutlined />,
      label: '进程与服务',
      children: [
        { key: 'process_list', icon: <AppstoreOutlined />, label: '进程列表' },
        { key: 'process_anomaly', icon: <AlertOutlined />, label: '进程异常检测' },
        { key: 'service_list', icon: <UnorderedListOutlined />, label: '系统服务' },
        { key: 'startup', icon: <ThunderboltOutlined />, label: '自启动信息' },
        { key: 'cron', icon: <ClockCircleOutlined />, label: '计划任务(Cron)' },
      ],
    },
    {
      key: 'linux_identity_group',
      icon: <TeamOutlined />,
      label: '身份与访问',
      children: [
        { key: 'user_list', icon: <TeamOutlined />, label: '用户列表' },
        { key: 'logged_users', icon: <UserOutlined />, label: '已登录用户' },
        { key: 'ssh_keys', icon: <KeyOutlined />, label: 'SSH密钥' },
        { key: 'sudo_config', icon: <KeyOutlined />, label: 'Sudo配置' },
      ],
    },
    {
      ...
      children: [
        ...
        { key: 'listen_ports', icon: <ApartmentOutlined />, label: '监听端口' },
        { key: 'hosts_file', icon: <FileSearchOutlined />, label: 'Hosts文件' },
        { key: 'dns_config', icon: <GlobalOutlined />, label: 'DNS配置' },
    ...
    },
    {
      ...
      children: [
        { key: 'suspicious_files', icon: <AlertOutlined />, label: '可疑文件' },
        { key: 'pam_config', icon: <LockOutlined />, label: 'PAM配置' },
        { key: 'sudoers_config', icon: <KeyOutlined />, label: 'Sudoers配置' },
        { key: 'selinux_status', icon: <SafetyOutlined />, label: 'SELinux状态' },
        { key: 'ulimit_config', icon: <DashboardOutlined />, label: '系统限制' },
      ],
    },
    {
      key: 'linux_trace_group',
      icon: <UserOutlined />,
      label: '用户痕迹',
      children: [
        { key: 'history_cmd', icon: <HistoryOutlined />, label: '历史命令' },
        { key: 'sudo_log', icon: <KeyOutlined />, label: 'Sudo日志' },
        { key: 'bashrc_check', icon: <CodeOutlined />, label: 'Bashrc检查' },
        { key: 'profile_check', icon: <FileTextOutlined />, label: 'Profile检查' },
        { key: 'recent_files', icon: <ClockCircleOutlined />, label: '最近访问文件' },
      ],
    },
    {
      ...
      label: '应用',
      children: [
        { key: 'docker', icon: <CloudServerOutlined />, label: 'Docker容器' },
        { key: 'docker_images', icon: <ContainerOutlined />, label: 'Docker镜像' },
        { key: 'panel', icon: <ControlOutlined />, label: '面板检测' },
        { key: 'database', icon: <DatabaseOutlined />, label: '数据库检测' },
      ],
    },
    {
      ...
      children: [
        ...
        { key: 'login_history', icon: <UserOutlined />, label: '登录历史' },
        { key: 'lastlog', icon: <UserOutlined />, label: '最后登录' },
        { key: 'cron_log', icon: <ClockCircleOutlined />, label: '定时任务日志' },
        { key: 'web_access_log', icon: <GlobalOutlined />, label: 'Web访问日志' },
      ],
    },
  );
